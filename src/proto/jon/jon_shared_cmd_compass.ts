...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.setMagneticDeclination !== undefined) {
      SetMagneticDeclination.encode(message.setMagneticDeclination, writer.uint32(26).fork()).ldelim();
    }
    if (message.setOffsetAngleAzimuth !== undefined) {
      SetOffsetAngleAzimuth.encode(message.setOffsetAngleAzimuth, writer.uint32(34).fork()).ldelim();
    }
    if (message.setOffsetAngleElevation !== undefined) {
      SetOffsetAngleElevation.encode(message.setOffsetAngleElevation, writer.uint32(42).fork()).ldelim();
    }
    if (message.setUseRotaryPosition !== undefined) {
      SetUseRotaryPosition.encode(message.setUseRotaryPosition, writer.uint32(50).fork()).ldelim();
    }
    if (message.startCalibrateLong !== undefined) {
      CalibrateStartLong.encode(message.startCalibrateLong, writer.uint32(58).fork()).ldelim();
    }
    if (message.startCalibrateShort !== undefined) {
      CalibrateStartShort.encode(message.startCalibrateShort, writer.uint32(66).fork()).ldelim();
    }
    if (message.calibrateNext !== undefined) {
      CalibrateNext.encode(message.calibrateNext, writer.uint32(74).fork()).ldelim();
    }
    if (message.calibrateCencel !== undefined) {
      CalibrateCencel.encode(message.calibrateCencel, writer.uint32(82).fork()).ldelim();
    }
