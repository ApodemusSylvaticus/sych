...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.getMeteo !== undefined) {
      GetMeteo.encode(message.getMeteo, writer.uint32(18).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    ...
    message.setDeviceState =
      object.setDeviceState !== undefined && object.setDeviceState !== null ? SetDeviceState.fromPartial(object.setDeviceState) : undefined;
...
export const SetDeviceState = {
  ...
  fromPartial<I extends Exact<DeepPartial<SetDeviceState>, I>>(object: I): SetDeviceState {
    ...
    message.powerOn = object.powerOn !== undefined && object.powerOn !== null ? PowerOn.fromPartial(object.powerOn) : undefined;
    message.powerOff = object.powerOff !== undefined && object.powerOff !== null ? PowerOff.fromPartial(object.powerOff) : undefined;
    message.powerReset = object.powerReset !== undefined && object.powerReset !== null ? PowerReset.fromPartial(object.powerReset) : undefined;
    message.canOn = object.canOn !== undefined && object.canOn !== null ? CanOn.fromPartial(object.canOn) : undefined;
    message.canOff = object.canOff !== undefined && object.canOff !== null ? CanOff.fromPartial(object.canOff) : undefined;
    message.canReset = object.canReset !== undefined && object.canReset !== null ? CanReset.fromPartial(object.canReset) : undefined;
    return message;
  },
};
