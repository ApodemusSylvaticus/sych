...
import { JonGuiDataRecOsdScreen, jonGuiDataRecOsdScreenFromJSON, jonGuiDataRecOsdScreenToJSON } from './jon_shared_data_types';
...
export const JonGuiDataRecOsd = {
  encode(message: JonGuiDataRecOsd, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.screen !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): JonGuiDataRecOsd {
  ...
  fromJSON(object: any): JonGuiDataRecOsd {
    return {
      ...
      heatCrosshairOffsetHorizontal: isSet(object.heatCrosshairOffsetHorizontal) ? globalThis.Number(object.heatCrosshairOffsetHorizontal) : 0,
      heatCrosshairOffsetVertical: isSet(object.heatCrosshairOffsetVertical) ? globalThis.Number(object.heatCrosshairOffsetVertical) : 0,
      dayCrosshairOffsetHorizontal: isSet(object.dayCrosshairOffsetHorizontal) ? globalThis.Number(object.dayCrosshairOffsetHorizontal) : 0,
      dayCrosshairOffsetVertical: isSet(object.dayCrosshairOffsetVertical) ? globalThis.Number(object.dayCrosshairOffsetVertical) : 0,
    };
  },
