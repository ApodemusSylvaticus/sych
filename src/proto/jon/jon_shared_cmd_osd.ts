...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.enableHeatOsd !== undefined) {
      EnableHeatOSD.encode(message.enableHeatOsd, writer.uint32(42).fork()).ldelim();
    }
    if (message.disableHeatOsd !== undefined) {
      DisableHeatOSD.encode(message.disableHeatOsd, writer.uint32(50).fork()).ldelim();
    }
    if (message.enableDayOsd !== undefined) {
      EnableDayOSD.encode(message.enableDayOsd, writer.uint32(58).fork()).ldelim();
    }
    if (message.disableDayOsd !== undefined) {
      DisableDayOSD.encode(message.disableDayOsd, writer.uint32(66).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    ...
    message.enableHeatOsd =
      object.enableHeatOsd !== undefined && object.enableHeatOsd !== null ? EnableHeatOSD.fromPartial(object.enableHeatOsd) : undefined;
    message.disableHeatOsd =
      object.disableHeatOsd !== undefined && object.disableHeatOsd !== null ? DisableHeatOSD.fromPartial(object.disableHeatOsd) : undefined;
    message.enableDayOsd =
      object.enableDayOsd !== undefined && object.enableDayOsd !== null ? EnableDayOSD.fromPartial(object.enableDayOsd) : undefined;
    message.disableDayOsd =
      object.disableDayOsd !== undefined && object.disableDayOsd !== null ? DisableDayOSD.fromPartial(object.disableDayOsd) : undefined;
    return message;
  },
};
...
export const EnableHeatOSD = {
  encode(_: EnableHeatOSD, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): EnableHeatOSD {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DisableHeatOSD = {
  encode(_: DisableHeatOSD, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DisableHeatOSD {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const EnableDayOSD = {
  encode(_: EnableDayOSD, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): EnableDayOSD {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const DisableDayOSD = {
  encode(_: DisableDayOSD, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): DisableDayOSD {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
