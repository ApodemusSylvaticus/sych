...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.setManualPosition !== undefined) {
      SetManualPosition.encode(message.setManualPosition, writer.uint32(26).fork()).ldelim();
    }
    if (message.setUseManualPosition !== undefined) {
      SetUseManualPosition.encode(message.setUseManualPosition, writer.uint32(34).fork()).ldelim();
    }
    if (message.getMeteo !== undefined) {
      GetMeteo.encode(message.getMeteo, writer.uint32(42).fork()).ldelim();
    }
    return writer;
  },
