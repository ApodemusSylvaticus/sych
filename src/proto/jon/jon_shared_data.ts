...
export const JonGUIState = {
  encode(message: JonGUIState, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.lrf !== undefined) {
      JonGuiDataLrf.encode(message.lrf, writer.uint32(34).fork()).ldelim();
    }
    if (message.time !== undefined) {
      JonGuiDataTime.encode(message.time, writer.uint32(42).fork()).ldelim();
    }
    if (message.gps !== undefined) {
      JonGuiDataGps.encode(message.gps, writer.uint32(50).fork()).ldelim();
    }
    if (message.compass !== undefined) {
      JonGuiDataCompass.encode(message.compass, writer.uint32(58).fork()).ldelim();
    }
    if (message.rotary !== undefined) {
      JonGuiDataRotary.encode(message.rotary, writer.uint32(66).fork()).ldelim();
    }
    if (message.cameraDay !== undefined) {
      JonGuiDataCameraDay.encode(message.cameraDay, writer.uint32(74).fork()).ldelim();
    }
    if (message.cameraHeat !== undefined) {
      JonGuiDataCameraHeat.encode(message.cameraHeat, writer.uint32(82).fork()).ldelim();
    }
    if (message.compassCalibration !== undefined) {
      JonGuiDataCompassCalibration.encode(message.compassCalibration, writer.uint32(90).fork()).ldelim();
    }
    if (message.power !== undefined) {
      JonGuiDataPower.encode(message.power, writer.uint32(98).fork()).ldelim();
    }
    if (message.recOsd !== undefined) {
      JonGuiDataRecOsd.encode(message.recOsd, writer.uint32(106).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<JonGUIState>, I>>(object: I): JonGUIState {
    ...
    message.compassCalibration =
      object.compassCalibration !== undefined && object.compassCalibration !== null
        ...
        : undefined;
    message.power = object.power !== undefined && object.power !== null ? JonGuiDataPower.fromPartial(object.power) : undefined;
    message.recOsd = object.recOsd !== undefined && object.recOsd !== null ? JonGuiDataRecOsd.fromPartial(object.recOsd) : undefined;
    return message;
  },
};
