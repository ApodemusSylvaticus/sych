...
import { Root as Root11 } from './jon_shared_cmd_cv';
...
import { Root as Root10 } from './jon_shared_cmd_power';
...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.power !== undefined) {
      Root10.encode(message.power, writer.uint32(258).fork()).ldelim();
    }
    if (message.cv !== undefined) {
      Root11.encode(message.cv, writer.uint32(266).fork()).ldelim();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 32:
          ...
          message.power = Root10.decode(reader, reader.uint32());
          continue;
        case 33:
          if (tag !== 266) {
            break;
          ...
          message.cv = Root11.decode(reader, reader.uint32());
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): Root {
    return {
      ...
      power: isSet(object.power) ? Root10.fromJSON(object.power) : undefined,
      cv: isSet(object.cv) ? Root11.fromJSON(object.cv) : undefined,
    };
  },
  ...
  toJSON(message: Root): unknown {
    ...
    if (message.power !== undefined) {
      obj.power = Root10.toJSON(message.power);
    }
    if (message.cv !== undefined) {
      obj.cv = Root11.toJSON(message.cv);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    ...
    message.power = object.power !== undefined && object.power !== null ? Root10.fromPartial(object.power) : undefined;
    message.cv = object.cv !== undefined && object.cv !== null ? Root11.fromPartial(object.cv) : undefined;
    return message;
  },
};
