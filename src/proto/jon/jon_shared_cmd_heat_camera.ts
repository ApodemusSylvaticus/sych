...
export const Root = {
  encode(message: Root, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.zoom !== undefined) {
      Zoom.encode(message.zoom, writer.uint32(10).fork()).ldelim();
    }
    if (message.setAgc !== undefined) {
      SetAGC.encode(message.setAgc, writer.uint32(18).fork()).ldelim();
    }
    if (message.setFilter !== undefined) {
      SetFilters.encode(message.setFilter, writer.uint32(26).fork()).ldelim();
    }
    ...
    if (message.photo !== undefined) {
      Photo.encode(message.photo, writer.uint32(50).fork()).ldelim();
    }
    if (message.zoomIn !== undefined) {
      ZoomIn.encode(message.zoomIn, writer.uint32(82).fork()).ldelim();
    }
    if (message.zoomOut !== undefined) {
      ZoomOut.encode(message.zoomOut, writer.uint32(90).fork()).ldelim();
    }
    if (message.zoomStop !== undefined) {
      ZoomStop.encode(message.zoomStop, writer.uint32(98).fork()).ldelim();
    }
    if (message.focusIn !== undefined) {
      FocusIn.encode(message.focusIn, writer.uint32(106).fork()).ldelim();
    }
    if (message.focusOut !== undefined) {
      FocusOut.encode(message.focusOut, writer.uint32(114).fork()).ldelim();
    }
    if (message.focusStop !== undefined) {
      FocusStop.encode(message.focusStop, writer.uint32(122).fork()).ldelim();
    }
    if (message.calibrate !== undefined) {
      Calibrate.encode(message.calibrate, writer.uint32(130).fork()).ldelim();
    }
    if (message.setDdeLevel !== undefined) {
      SetDDELevel.encode(message.setDdeLevel, writer.uint32(138).fork()).ldelim();
    }
    if (message.enableDde !== undefined) {
      EnableDDE.encode(message.enableDde, writer.uint32(146).fork()).ldelim();
    }
    if (message.disableDde !== undefined) {
      DisableDDE.encode(message.disableDde, writer.uint32(154).fork()).ldelim();
    }
    if (message.setAutoFocus !== undefined) {
      SetAutoFocus.encode(message.setAutoFocus, writer.uint32(162).fork()).ldelim();
    }
    if (message.focusStepPlus !== undefined) {
      FocusStepPlus.encode(message.focusStepPlus, writer.uint32(170).fork()).ldelim();
    }
    if (message.focusStepMinus !== undefined) {
      FocusStepMinus.encode(message.focusStepMinus, writer.uint32(178).fork()).ldelim();
    }
    if (message.setFxMode !== undefined) {
      SetFxMode.encode(message.setFxMode, writer.uint32(186).fork()).ldelim();
    }
    if (message.nextFxMode !== undefined) {
      NextFxMode.encode(message.nextFxMode, writer.uint32(194).fork()).ldelim();
    }
    if (message.prevFxMode !== undefined) {
      PrevFxMode.encode(message.prevFxMode, writer.uint32(202).fork()).ldelim();
    }
    if (message.getMeteo !== undefined) {
      GetMeteo.encode(message.getMeteo, writer.uint32(210).fork()).ldelim();
    }
    if (message.shiftDde !== undefined) {
      ShiftDDE.encode(message.shiftDde, writer.uint32(218).fork()).ldelim();
    }
    if (message.refreshFxMode !== undefined) {
      RefreshFxMode.encode(message.refreshFxMode, writer.uint32(226).fork()).ldelim();
    }
    if (message.resetZoom !== undefined) {
      ResetZoom.encode(message.resetZoom, writer.uint32(234).fork()).ldelim();
    }
    if (message.saveToTable !== undefined) {
      SaveToTable.encode(message.saveToTable, writer.uint32(242).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Root>, I>>(object: I): Root {
    ...
    message.setAgc = object.setAgc !== undefined && object.setAgc !== null ? SetAGC.fromPartial(object.setAgc) : undefined;
    message.setFilter = object.setFilter !== undefined && object.setFilter !== null ? SetFilters.fromPartial(object.setFilter) : undefined;
    ...
    message.zoomIn = object.zoomIn !== undefined && object.zoomIn !== null ? ZoomIn.fromPartial(object.zoomIn) : undefined;
    message.zoomOut = object.zoomOut !== undefined && object.zoomOut !== null ? ZoomOut.fromPartial(object.zoomOut) : undefined;
    message.zoomStop = object.zoomStop !== undefined && object.zoomStop !== null ? ZoomStop.fromPartial(object.zoomStop) : undefined;
    message.focusIn = object.focusIn !== undefined && object.focusIn !== null ? FocusIn.fromPartial(object.focusIn) : undefined;
    message.focusOut = object.focusOut !== undefined && object.focusOut !== null ? FocusOut.fromPartial(object.focusOut) : undefined;
    message.focusStop = object.focusStop !== undefined && object.focusStop !== null ? FocusStop.fromPartial(object.focusStop) : undefined;
    message.calibrate = object.calibrate !== undefined && object.calibrate !== null ? Calibrate.fromPartial(object.calibrate) : undefined;
    message.setDdeLevel = object.setDdeLevel !== undefined && object.setDdeLevel !== null ? SetDDELevel.fromPartial(object.setDdeLevel) : undefined;
    message.enableDde = object.enableDde !== undefined && object.enableDde !== null ? EnableDDE.fromPartial(object.enableDde) : undefined;
    message.disableDde = object.disableDde !== undefined && object.disableDde !== null ? DisableDDE.fromPartial(object.disableDde) : undefined;
    ...
    message.focusStepPlus =
      object.focusStepPlus !== undefined && object.focusStepPlus !== null ? FocusStepPlus.fromPartial(object.focusStepPlus) : undefined;
    message.focusStepMinus =
      object.focusStepMinus !== undefined && object.focusStepMinus !== null ? FocusStepMinus.fromPartial(object.focusStepMinus) : undefined;
    ...
    message.shiftDde = object.shiftDde !== undefined && object.shiftDde !== null ? ShiftDDE.fromPartial(object.shiftDde) : undefined;
...
export const ShiftDDE = {
  encode(message: ShiftDDE, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.value !== 0) {
      writer.uint32(8).int32(message.value);
    }
    return writer;
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): ShiftDDE {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FocusStepPlus = {
  encode(_: FocusStepPlus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): FocusStepPlus {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const FocusStepMinus = {
  encode(_: FocusStepMinus, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): FocusStepMinus {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const Zoom = {
  encode(message: Zoom, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.setZoomTableValue !== undefined) {
      SetZoomTableValue.encode(message.setZoomTableValue, writer.uint32(10).fork()).ldelim();
    }
    if (message.nextZoomTablePos !== undefined) {
      NextZoomTablePos.encode(message.nextZoomTablePos, writer.uint32(18).fork()).ldelim();
    }
    if (message.prevZoomTablePos !== undefined) {
      PrevZoomTablePos.encode(message.prevZoomTablePos, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
